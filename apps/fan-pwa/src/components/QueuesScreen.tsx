...
function QueueRow({ q }: { q: QueueInfo }) {
  ...
  return (
    <div className="tile flex items-center gap-3" style={{ borderLeft: `3px solid ${level.color}` }}>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <span className="font-medium text-[15px] capitalize">
            {q.queue_id.replace(/-/g, " ")}
          </span>
          <span
      ...
      <div className="text-right">
        <div className="mono text-xl text-ink" style={{ color: level.color }}>
